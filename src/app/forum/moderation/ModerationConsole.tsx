...
/**
 * Selve konsollen. Rendres kun av server-siden i page.tsx, og bare for en
 * innlogget bruker med moderator- eller admin-rolle — knappene «Marker som
 * løst / Avvis» skal ikke stå og blinke for noen som ikke kan trykke på dem.
 */
