...
**Funnene viser hvor folk *leter*, ikke bare hvor soppen *står*.** Prikkene klumper seg langs stier, ved parkeringsplasser og rundt byene — fordi det er der plukkerne går. Tomme områder på kartet er oftere ubesøkte enn soppløse. De beste stedene dine kommer aldri til å stå på noe kart, og [slik leser du terrenget](/sanketips/les-terrenget) for å finne dem selv.

## Fra historikk til «akkurat nå»

Historiske funn svarer på «hvor har det vært sopp». Det andre spørsmålet — «er det sopp *nå*?» — krever vær, sesong og skogdata, og det er den delen vi faktisk kan måle treffsikkerheten på: kartlaget «Lovende områder» kombinerer funnhistorikken med [soppforholdene i dag](/soppforhold) og skogtypen fra NIBIO. Vi lover ikke steder — vi rangerer *når* og *hvilken skog*, og publiserer [fasiten åpent](/apenhet). Vil du ha beskjed når det snur i ditt område, gjør [soppvarselet](/soppvarsel) det gratis.
