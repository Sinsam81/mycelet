...
- En tioårig övervakning av karljohan i tysk bokskog testade fönster från 2 till 35 dygn och fann att korttidsnederbörden ensam sa lite: fruktifieringen ökade med nederbörden ackumulerad över de senaste **26 dygnen**, något författarna knyter till tiden det tar att bygga upp och behålla markfuktigheten. Dessutom fann de ett temperaturoptimum runt 13 grader, mätt som snitt över de 20 föregående dygnen. (Preprint, inte fackgranskad — utökad version juni 2026; bokskog vid Bielefeld, inte nordisk barrskog.)
- En kanadensisk studie av en kantarellvarietet (*C. cibarius* var. *roseocanus*) i banksianatallskog i östra Kanada fann starkast samband med nederbörd **en vecka** före och lufttemperatur **två veckor** före fruktifiering.
- I medelhavstallskog i Spanien slog nederbörden igenom i svampskörden först ungefär **en månad** senare — men modellen räknade i hela månader, så «en månad» är upplösningen, inte ett exakt uppmätt tal.
...
- Författarna ska ha antytt att hösttoppen kunde vara ett svar på att temperaturen faller under runt 14 grader ett par veckor tidigare. Liksom punkten nedan är detta återgivet i andra hand — originalet ligger bakom betalvägg — och det var en hypotes, inte ett bevisat fynd. Tröskeln är härledd ur månadstemperaturer på en lågplatå vid 46:e breddgraden, så siffran ska inte flyttas rakt av till nordisk höjd och breddgrad.
- En grad varmare sommar sammanföll med ungefär **en veckas försenad** fruktifiering. Siffran är återgiven efter Pinna m.fl. (2010); vi har inte kunnat läsa originalet, som ligger bakom betalvägg, och återger den därför som andrahandsuppgift.
...
- **Vattenbalansen** är en enkel hinkmodell för rotzonen: 50 millimeters kapacitet, fylls av nederbörd, töms av avdunstning beräknad ur dygnstemperaturen. Det är inte uppmätt markfuktighet. Ingen jordart, ingen lutning, ingen infiltration. Men den löser problemet att en rå 14-dagars regnsumma ser lika hög ut två veckor efter en enda gammal skyfallsdag, tvärs genom en torrperiod.
- **Habitatet** kommer från norska NIBIO-data om bonitet och skogsvolym, plus en värdträdsspärr som pressar poängen mot noll där skogen inte kan hysa arten. Täckningen är norsk — **svenska användare får en grövre habitatbedömning**, och det säger vi hellre rakt ut än låtsas något annat.
- **Säsongskurvorna** är byggda empiriskt ur 316 542 daterade nordiska fynd för 70 arter (ögonblicksbild 2 augusti 2026): 52 veckovärden per art, utjämnade, delade i tre breddgradsband. Men det är fyndposter, inte systematiska räkningar, och de bär på insamlingsbias: helger, vägar, befolkningstäthet. Underlaget är för övrigt svensktungt — för kärnarterna har vi runt 200 svenska väderprofiler mot 25 norska per art.
- **Fördröjningstiderna** varierar per släkte: runt fem dagar för karljohan och strävsoppar, runt två veckor för kantarell och trattkantarell, längst för taggsvampar (*Hydnum*). Alla andra släkten får en standard på åtta dagar. Koden säger det rakt ut om sig själv: det här är fältregler, inte laboratoriekonstanter. Kantarellens två veckor står strängt taget i strid med den enda relevanta studien, som fann en vecka. Taggsvampssiffran har vi inte hittat källstöd för över huvud taget.
- **Karljohan är fortfarande olöst.** I vårt eget stränga holdout-test presterade temperaturprofilen för karljohan sämre än slumpen. Antingen är urvalet för litet och skevt — eller så ligger nyckeln i en *sekvens* (varm sommar, sedan kyla, sedan regn), som erfarna plockare beskriver den, och ingen enkel temperaturtröskel kan fånga det.
- **Fjolårets väder** modellerar vi inte alls, trots att norska herbariedata visar att förra årets temperatur och nederbörd har mätbar effekt. Mycelet är flerårigt; vårt minne är det inte.
...
- Räkna från markfuktigheten, inte från senaste skuren. Har det varit torrt länge, skriv av det första regnet.
- Räkna runt fem dagar för strävsoppar och karljohan, runt två veckor för kantarell och trattkantarell, och ännu lite längre för taggsvamp — men det här är appens egna fältregler, inte uppmätta tal. Gå och se, och kalibrera mot ditt eget område.
- Håll koll när hösttemperaturen faller mot runt 14 grader. Siffran kommer från en enda schweizisk skogsyta, så använd den som fingervisning, inte tröskel.
- Anteckna datumet när du hittar något. Dina egna ställen över några säsonger slår varje generell modell på just *din* terräng.
- Kommer det ingenting? Kolla om juli var torr. Säsonger kan svika helt, och det är inte ditt fel.
- Och det viktigaste: timing säger ingenting om vad du kan äta. Är du osäker på arten, låt den stå.
...
- Brejon Lamartiniere & Hoffman (2025): [karljohan i centraleuropeisk bokskog, tioårig övervakning](https://www.biorxiv.org/content/10.64898/2025.12.12.693895v2). bioRxiv — **preprint, inte fackgranskad**; version 2 (juni 2026) med utökad fönsteranalys.
- Straatsma, Ayer & Egli (2001), *Mycological Research* 105: 515–523: 21 år av veckovis registrering på schweizisk skogsyta (La Chanéaz).
- Karavani m.fl. (2018), *Agricultural and Forest Meteorology*: nederbörd, markfuktighet och svampskörd i medelhavstallskog (Poblet, Katalonien).
- Pinna m.fl. (2010), *Forest Ecology and Management* 260: 294–301: startdatum och varaktighet för fruktifiering, blandad boreal skog i Gaspésie, östra Kanada.
- Rochon m.fl. (2011), *Botany* 89: 663–675, [doi:10.1139/b11-058](https://cdnsciencepub.com/doi/10.1139/b11-058): kantarell (*C. cibarius* var. *roseocanus*) i banksianatallskog — nederbörd en vecka före och lufttemperatur två veckor före.
- Krah m.fl. (2023), *Ecology Letters*: 6,1 miljoner fyndposter, säsongstoppar och rumslig synkronisering.
- Kauserud m.fl. (2008), *PNAS*: norska herbariebelägg 1940–2006, försenad fruktifiering och effekten av fjolårets väder.
- *Tree Physiology* (2025): koltransport från barr till ektomykorrhiza-fruktkroppar.
- Giftinformationscentralen: trattkantarell och toppig giftspindling.
