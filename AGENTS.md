...
SoppJakt — a Norwegian mushroom-foraging app. UI strings, docs, and commit messages are in Norwegian. Code identifiers and Codex-facing notes are in English.
