...
Det er en formidabel dugnad. Da vi slo opp i GBIF 9. august 2026, lå det **2 358 630 registrerte soppfunn fra Norge**. Av dem er 61 prosent merket «human observation» — noen så en sopp og skrev det ned — og 30 prosent er herbariebelegg.

Mycelet bruker en delmengde av dette. Appen har drøyt 428 000 registrerte funn i basen totalt; de romlige og sesongmessige analysene i denne artikkelen er kjørt på GBIF-uttrekket vårt på 327 298 forekomstpunkter, hvorav 316 542 har en brukbar dato. Sesongkurvene i appen er bygget på de sistnevnte, for rundt 70 arter.

Merk hva som *ikke* finnes i noen av disse tallene: nullpunktene. Ingen registrerer «jeg gikk i denne lia i tre timer og fant ingenting». Dataene er det fagfolk kaller *presence-only* — bare tilstedeværelse. GBIF har riktignok et eget felt for ekte fraværsobservasjoner, men de er sjeldne, og [GBIFs egen opplæringsdokumentasjon](https://docs.gbif.org/course-data-use/en/gridded-datasets.html) understreker forskjellen: et bekreftet fravær er noe helt annet enn en manglende registrering.
...
**Helgen.** Denne ville vi måle selv, på norske soppdata. Vi trakk et lagdelt tilfeldig utvalg på 74 750 registrerte soppobservasjoner fra Norge i perioden 2015–2025 (GBIF, «human observation», med koordinat), fordelt på 132 lag etter år og måned og vektet tilbake til den sanne størrelsen på hvert lag — til sammen 907 144 funn.

Resultatet: **32,6 prosent av funnene ble gjort i helgen.** Med jevn fordeling skulle det vært 28,6 prosent. Per dag betyr det omtrent 1,2 ganger så mange registreringer på en lørdag som på en tirsdag. Lørdag er den travleste dagen (17,1 prosent av alle funn), mandag den roligste (11,4 prosent).

Det er en reell skjevhet, men en moderat en — og det er verdt å si tydelig, for den hadde vært lett å blåse opp. Til sammenligning fant [Courter og medarbeidere (2013)](https://pubmed.ncbi.nlm.nih.gov/23104424/) en helgeandel på 32 prosent for førsteankomster av trekkfugl i Nord-Amerika, og et [ferskt preprint](https://www.biorxiv.org/content/10.1101/2024.07.22.604598v1) peker på ukedag som en av hoveddriverne bak registreringsaktivitet i det hele tatt. At helt ulike organismegrupper på to kontinenter lander på omtrent samme tall, er en påminnelse om at dette handler om arbeidsuker, ikke om biologi.
...
- jordas dreneringsgrad: **rundt 0,47**

Sammenfattet: rundt **0,52**. Nær myntkast. Legg spesielt merke til den tredje linjen: ren forekomsttetthet gjorde det *verre* enn tilfeldig. Å sende folk dit det er registrert mest sopp fra før var, i vår måling, marginalt dårligere enn å velge et sted i blinde.
...
Vi gikk i den samme fellen mens vi skrev denne artikkelen. Første forsøk på å måle helgeskjevheten hentet de første 3 000 postene per år fra GBIF, uten å tenke over at API-et leverer dem i datorekkefølge. Utvalget besto nesten utelukkende av januar og februar, og ga en helgeandel på 44,8 prosent. Vintersopping er en utpreget helgeaktivitet, så tallet var «riktig» for det utvalget — og fullstendig feil som svar på spørsmålet vi stilte. Derfor den lagdelte metoden beskrevet ovenfor.

Lærdommen er den samme begge ganger: **et tall som ser lovende ut, fra en test som ikke kontrollerer for den ene tingen du vet er en konfunderende faktor, er verdiløst.** Det gjelder også når tallet er ditt eget og du gjerne vil at det skal stemme.
...
Vi skal ikke overdrive renheten her heller: helgeskjevheten er en tidsskjevhet, og den treffer altså tidsmodellen vår også. Courter og medarbeidere målte at helgeeffekten forskjøv beregnede ankomstdatoer for fugl med rundt en halv dag. Det er lite sammenlignet med usikkerheten ellers i et soppvarsel, men det er ikke null.
...
Den avgjørende asymmetrien: **et punkt er ekte informasjon. Et tomt område er ingen informasjon.** Når noen har registrert kantarell (*Cantharellus cibarius*) i en li, så har det faktisk vokst kantarell i den lia. Det er et observert faktum. At nabolia er blank, forteller deg ingenting i det hele tatt — bortsett fra at ingen har meldt derfra.
...
- **Å vite hva du bør lære å kjenne igjen — også det farlige.** Er hvit fluesopp (*Amanita virosa*) eller spiss giftslørsopp (*Cortinarius rubellus*) registrert i ditt område, er det verdt å kunne dem godt. Begge er dødelige. Giftslørsoppen er særlig lumsk fordi symptomene på nyreskade kan komme flere døgn etter måltidet, lenge etter at man har glemt hva man spiste.
- **Et utgangspunkt for egne turer.** Ikke en fasit — en hypotese du går ut og tester.
- **Å finne skogtypen, ikke stedet.** Ser du at en art er meldt fra gammel granskog med høy bonitet, er det den *typen* skog du skal lete i. Det generaliserer. Selve punktet gjør det ikke.

Og det beste kartet over ditt eget terreng lager du selv. Noen sesonger med egne, daterte notater slår enhver generell modell på akkurat de liene du faktisk går i.
...
Er du det minste i tvil: la den stå. Bruk soppkontroll. Norges sopp- og nyttevekstforbund driver kontroller mange steder i landet, mest i august og september — sjekk oversikten på [soppognyttevekster.no](https://soppognyttevekster.no/) før du drar. Ingen app og intet kart, dette inkludert, er en erstatning for det.
...
- GBIF, [Biodiversity Data Use](https://docs.gbif.org/course-data-use/en/gridded-datasets.html) — forskjellen på fraværsposter og manglende poster.
...
- Zizka, Antonelli & Silvestro (2021), *Ecography*, [sampbias](https://doi.org/10.1111/ecog.05102) — metode for å tallfeste tilgjengelighetsskjevhet (vei, by, elv, flyplass).
- Courter m.fl. (2013), *International Journal of Biometeorology* 57: 715–720, [Weekend bias in Citizen Science data reporting](https://pubmed.ncbi.nlm.nih.gov/23104424/) — 32 % helgeandel i nyere data; forskyver beregnede datoer med rundt en halv dag.
- Rosário m.fl. (2024), [Drivers of temporal bias in biodiversity recording by citizen scientists](https://www.biorxiv.org/content/10.1101/2024.07.22.604598v1) — ukedag blant hoveddriverne for registreringsaktivitet. **Preprint, ikke fagfellevurdert.**
- Egne uttrekk fra GBIFs åpne API, 9. august 2026: 2 358 630 soppfunn fra Norge; fordeling på posttype; lagdelt utvalg på 74 750 daterte funn 2015–2025 for ukedagsfordelingen.
- Mycelets egne valideringskjøringer: fenologi AUC 0,88; romlig modell 0,504, habitat 0,536, forekomsttetthet 0,472.
